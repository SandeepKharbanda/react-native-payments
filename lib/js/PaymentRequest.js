...
export default class PaymentRequest {
  ...
  _handleUserAccept(details: {
    ...
    const paymentResponse = new PaymentResponse({
      ...
      payerName: this._options.requestPayerName && this._shippingAddress ? this._shippingAddress.recipient : null,
      payerPhone: this._options.requestPayerPhone && this._shippingAddress ? this._shippingAddress.phone : null,
